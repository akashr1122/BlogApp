            ...
            <DrawerBody p={0}>
              <Flex direction="column" p={4}>
               ...
               <Link to ='/about'> <Button variant="ghost" color="white" mb={4} onClick={onClose}>About</Button></Link>
                ...
                <Button onClick={logout} variant="ghost" color="white" mb={4}>Logout</Button>
             <Link to="/"> <IconButton as={Link} to="/" colorScheme="teal" aria-label="Profile"icon={<RiUserLine />}borderRadius="full" /></Link>
              </Flex>
            </DrawerBody>
          </DrawerContent>
        </Drawer>
